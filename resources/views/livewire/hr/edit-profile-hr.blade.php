<div>
    <x-breadcrumb :items="[['label' => 'Profile', 'url' => route('hr.profile')], ['label' => 'Edit', 'url' => null]]" />
            ...
            <div>
                ...
                <div class="flex items-center gap-6">
                    <div class="relative w-24 h-24 rounded-full bg-surface-container flex items-center justify-center overflow-hidden border border-surface-container-high">
                        ...
                        @endif
                        <div wire:loading.flex wire:target="photo" class="absolute inset-0 bg-surface/50 items-center justify-center z-10">
